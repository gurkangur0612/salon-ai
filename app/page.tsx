...
<label className="rounded-2xl border border-dashed border-[#2d6a5e]/30 bg-[#eef3f0] p-4 text-left">
  ...
  {topPreview && (
    ...
    {analysis && <section id="analysis" className="scroll-mt-6 border-y border-black/10 bg-[#173c35] px-5 py-16 text-white"><div className="mx-auto max-w-6xl"><div className="flex flex-wrap items-end justify-between gap-5"><div><p className="text-xs font-black tracking-[.22em] text-[#e1b181]">KİŞİSEL ANALİZ</p><h2 className="mt-2 text-4xl font-black">Berber için net bir yol haritası</h2></div><p className="max-w-md text-sm leading-6 text-white/65">Fotoğrafta açıkça görülen kozmetik özelliklere dayalı yaklaşık değerlendirme.</p></div>
